...
The mean value of the taken steps, excluding missing records is `r round(mean(daily_steps, na.rm=TRUE ),2)` and the median value is `r median(daily_steps, na.rm=T)`.
...
The mean value of the taken steps, excluding missing records is `r round(mean(daily_steps, na.rm=TRUE ),2)` and the median value is `r median(daily_steps, na.rm=T)`. in the new data-set after the imputation of the missing observations the mean and the median have values of `r round(mean(new_daily_steps, na.rm=TRUE ),2)` and `r median(new_daily_steps, na.rm=T)` respectively. Only the mean value  slightly changes. 
